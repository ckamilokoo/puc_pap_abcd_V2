...
class Caso(db.Model):
    ...
    situacion_problema = db.Column(db.String(500), nullable=False)
    caracteristicas_de_la_persona = db.Column(db.String(1000), nullable=False)
...
class Antecedentes(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    nombre_persona = db.Column(db.String(500), nullable=False)
    tipo_de_evento_traumatico = db.Column(db.String(500), nullable=False)
    lugar_del_evento = db.Column(db.String(500), nullable=False)
    edad = db.Column(db.Integer, nullable=True)
    con_quien_vive = db.Column(db.String(500), nullable=True)
